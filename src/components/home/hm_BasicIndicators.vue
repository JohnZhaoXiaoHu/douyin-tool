...
export default {
    ...
    mounted(){
        ...
        // 基础指标数据配置
        this.basicInfoDataList = zm_homeBasicInfo();
        ...
        this.request_trackAdminBasic(12348);
        this.request_trackAdminBasic(567);
    ...
    methods:{
        ...
        tkMoneySort(){
            ...
            homehttp.post( baseapi.hometkMoney,data).then(res=>{
                // console.log('---tkMoneySort= '+res.data.list);
        ...
        request_trackAdminBasic(type, startTime, endTime, dataType, dataName){
            // 请求: 基础指标概览
            let self = this;
            let params = new FormData();  
            if (type==12348) {
                 params.append('t', 'pvuv');
            } else if (type==567){
                 params.append('t', 'order');
            }  
            ...
            this.$http({
                ...
                // console.log('---基础指标概览: response= '+zm_jsonToString(res.data));
...
//             allUnit: '人',   
                ...
                if (type==12348) {
                    self.basicData1 = res.data;
                    // console.log('---基础指标概览: self.basicData1= '+zm_jsonToString(self.basicData1));

                    // 1.小程序uv
                    self.basicInfoData1.percent1 = self.basicData1.uv.hb;
                    self.basicInfoData1.percent2 = self.basicData1.uv.tb;
                    self.basicInfoData1.num      = self.basicData1.uv.num;
                    self.basicInfoData1.allNum   = self.basicData1.uv.total;
                    // 2.小程序pv
                    self.basicInfoData2.percent1 = self.basicData1.pv.hb;
                    self.basicInfoData2.percent2 = self.basicData1.pv.tb;
                    self.basicInfoData2.num      = self.basicData1.pv.num;
                    self.basicInfoData2.allNum   = self.basicData1.pv.total;
                    // 3.小程序新用户数
                    self.basicInfoData3.percent1 = self.basicData1.newUser.hb;
                    self.basicInfoData3.percent2 = self.basicData1.newUser.tb;
                    self.basicInfoData3.num      = self.basicData1.newUser.num;
                    self.basicInfoData3.allNum   = self.basicData1.newUser.total;
                    // 4.小程序活跃用户数
                    self.basicInfoData4.percent1 = self.basicData1.activityUser.hb;
                    self.basicInfoData4.percent2 = self.basicData1.activityUser.tb;
                    self.basicInfoData4.num      = self.basicData1.activityUser.num;
                    self.basicInfoData4.allNum   = self.basicData1.activityUser.total;
                    // 8.访问平均时长
                    self.basicInfoData8.percent1 = self.basicData1.staySec.hb;
                    self.basicInfoData8.percent2 = self.basicData1.staySec.tb;
                    self.basicInfoData8.num      = self.basicData1.staySec.num;
                    self.basicInfoData8.allNum   = self.basicData1.staySec.total;

                } else if (type==567){

                    self.basicData2 = res.data;
                    // 5.小程序销售额
                    self.basicInfoData5.percent1 = self.basicData2.sale.hb;
                    self.basicInfoData5.percent2 = self.basicData2.sale.tb;
                    self.basicInfoData5.num      = self.basicData2.sale.num;
                    self.basicInfoData5.allNum   = self.basicData2.sale.total;
                    // 6.支付订单数
                    self.basicInfoData6.percent1 = self.basicData2.pay.hb;
                    self.basicInfoData6.percent2 = self.basicData2.pay.tb;
                    self.basicInfoData6.num      = self.basicData2.pay.num;
                    self.basicInfoData6.allNum   = self.basicData2.pay.total;
                    // 7.维权订单数
                    self.basicInfoData7.percent1 = self.basicData2.afterSale.hb;
                    self.basicInfoData7.percent2 = self.basicData2.afterSale.tb;
                    self.basicInfoData7.num      = self.basicData2.afterSale.num;
                    self.basicInfoData7.allNum   = self.basicData2.afterSale.total;
                }  
            },function(res){
                self.$message.error(res.data.message);
            })
        ...
        financeNum(papme,select){
          if(this.timevalue != ''){
            ...
            //    console.log('---financeNum= '+res.data.list);
               let list = res.data.list;
               let qushidata = [];
               let qushidatatime = [];
               list.forEach(function(item,index){
        ...
        dayOrderNumMethod(papme,select){
            ...
            homehttp.post( baseapi.dayorderxse,data).then(res=>{
            //    console.log('---dayorderxse= '+res.data.list);
               let list = res.data.list;
               let qushidata = [];
               let qushidatatime = [];
               list.forEach(function(item,index){
        ...
        aftersaleNum(papme,select){
            ...
            //    console.log('---aftersaleNum= '+res.data.list);
               let list = res.data.list;
               let qushidata = [];
               let qushidatatime = [];
               list.forEach(function(item,index){
