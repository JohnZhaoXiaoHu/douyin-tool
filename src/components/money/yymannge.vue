    ...
    <div class="main-right">
        ...
        <div class="main-goods">
            ...
            <div class="main-goods-right">
                <!-- 商品中心内容 -->
                <div class="goods-card_body" style="height:100%">
                    <!--选项卡组件-->
...
import monavbar from './monavbar';
export default {
    data() {
        return {
          add:'',
          src: window.g.zhangUrl + '/MicroDistribution/FinancialManagement/fm_CommissionToBalance.html'
