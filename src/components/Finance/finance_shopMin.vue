                      ...
                      <div class="shuaixuan mh-goods-shuaixuan">
                        ...
                        <div class="goods_table-all">
                            <el-table
                                ...
                                <el-table-column prop="userId" label="店铺ID" width="90">
                                </el-table-column>
                                <el-table-column prop="userNickName" label="店铺名称">
                    ...
                    <el-tab-pane label="财务驳回记录" name="five">
                        ...
                        <div class="goods_table-all">
                            <el-table                         
                                    ...
                                    :default-sort = "{prop: 'date', order: 'descending'}"
                                    @selection-change="goodshandleSelectionChange">     
                                <el-table-column prop="userId" label="店铺ID" width="80">
                                </el-table-column>
                                <el-table-column prop="userNickName" label="店铺名称">
                                    <template slot-scope="scope">
                                        <div class="mh-finance-tab-div">
