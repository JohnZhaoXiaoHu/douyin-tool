                    ...
                    <el-tab-pane label="提现申请" name="first">
                      ...
                      <div class="shuaixuan mh-goods-shuaixuan">
                          ...
                          <div class="m-search-box el-row el-row-my-div mh-finance-input">
                             ...
                             <div class="mh-finance-input" >
                                <label class="el-form-item__label" style="width: 130px;">供应商</label>
                                <el-input v-model="sourceType" placeholder="请输入供应商ID"></el-input>
                                <!-- <el-select v-model="sourceType" placeholder="请选择供应商">
                        ...
                        <div class="goods-sx-btn" style="display: flex;">
                        ...
                        <div class="goods_table-all">
                            <el-table
                                ...
                                <el-table-column label="供应商" width="100px">
                                    <template slot-scope="scope">
                                        <div>{{scope.row.createTime.userNickName}}</div>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="createTime" label="申请时间" width="145px">
                                    <template slot-scope="scope">
                    ...
                    <el-tab-pane label="财务驳回记录" name="five">
                        ...
                        <div class="m-search-box el-row el-row-my-div mh-finance-input">
                            <div class="vip-item-list_time mh-market-timeleght" >
                             ...
                             <div class="mh-finance-input" style="display: flex;" >
                                <label class="el-form-item__label" style="width: 130px;">供应商</label>
                                <el-input v-model="sourceType" placeholder="请输入供应商ID"></el-input>
                                <!-- <el-select v-model="sourceType" placeholder="请选择供应商">
                                    <el-option v-for="item in sourceList"
