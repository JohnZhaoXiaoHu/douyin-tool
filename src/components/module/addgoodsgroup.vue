                    ...
                    <!--中心内容-->
                     <div class="container">
                        ...
                        <div class="component-small-list">
                            <div class="mwx-inputparent">
                                <div class="wx-use-module mwx-input" style="margin-bottom:10px">
                                    <el-input v-model="customtxt" type="text" placeholder="新增商品分组名称"></el-input>
                                </div>
                           </div>
                      ...
                      <div class="mh-module-style">
                        ...
                        <!-- <div class="blank"></div> -->
                        <div  class="wx-h5-header pmoudel-title"><div class="wx-h5-hd_title"></div> <div class="wx-h5-hd_nav"><div data-v-a4993752="" class="divider"></div> <div class="options-btn"></div> <div  class="close-btn"></div></div></div>
...
<script>
import secnavbar from '../goods/secnavbar';
