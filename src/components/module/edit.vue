  ...
  export default {
    ...
    mounted() {
      ...
      promises.then(function() {
        UTIL.vueRequest(self, "/miniprogram/wx/custom/detail/get.do", "post", "json", {id:self.parentid,lastModify : 0},
          ...
          function(data) {
            ...
            self.customtxt  = data.data.customName;
            let c = data.data.wxUserCustomComponents;
            for(let i in c) {
              let obj = {};
    ...
    methods: {
      ...
      closeCao(){
        ...
        UTIL.vueRequest(self, "/miniprogram/wx/custom/detail/up.do", "post", "json", self.$qs.stringify({id:self.parentid,content: JSON.stringify(objs),name:self.customtxt,description:'空'}),
          "application/x-www-form-urlencoded",
          function(data) {
            console.log(data);
            if(data.status == 200){
