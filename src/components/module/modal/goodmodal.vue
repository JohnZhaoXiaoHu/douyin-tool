<template>
  <el-dialog title="商品列表" :show-close="showClose" :visible.sync="config.visible" center @open="openCheckHandler">
  ...
  export default {
    ...
    methods: {
      loadGoods(current) {
        //直接查询出售中的商品
        let self = this;
        UTIL.vueRequestApi(this, "/shop/item/admin/list", "post", "json", this.$qs.stringify({page: current, limit: this.goods.pagination.limit, sinventoryType: 1, sname: this.keyword}), "application/x-www-form-urlencoded", function(data) {
