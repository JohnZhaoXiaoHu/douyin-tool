  ...
  <div class="component-form">
    <div class="component-form-list">
      ...
      <div class="component-form-line">
        ...
        <div class="form-input">
          <el-input v-model="config.moduleName" placeholder="请输入名称"></el-input>
        </div>
      </div>
      <div class="component-form-line">
...
<!--      <div class="component-form-line">
    ...
    <sevengoodmodal :config="goodconfig"></sevengoodmodal>
  </div>
</template>
