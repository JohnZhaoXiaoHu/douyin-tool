<template>
  <div class="component-7" :style="{backgroundColor: customStyle.backgroundColor}">
    <div class="goode-box-module-name" v-if="config.moduleName != ''">{{config.moduleName}}</div>
    <div v-if="datas.length > 0" :class="'good-box-' + config.listType" :style="{paddingLeft: padding, paddingRight: padding}">
    ...
    <div v-if="datas.length == 0" class="good-box-2" style="padding-left: 8px; padding-right: 8px;">
      <div class="good-item-wrapper">
        <div class="good-item" style="border-radius: 8px; border: 1px solid #EEEEEE;">
          <div class="good-item-image showPercent-2" style="border-top-left-radius: 8px; border-top-right-radius: 8px">
            <div class="my-image fillType-2">
              <img src="../../../../static/images/moduledefault/good.png" style="border-radius: 8px;"/>
            </div>
          </div>
          <div class="good-item-content">
            <div class="good-item-name">商品名称</div>
            <div class="good-item-buypoint">商品卖点</div>
            <div class="good-item-price">¥99.00</div>
          </div>
          <div class="show-type">
            <i class="fa fa-cart-plus"></i>
          </div>
