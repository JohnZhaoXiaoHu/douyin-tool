                ...
                <!-- 选品中心内容 -->
                  <div class="goods-card_body"  v-loading="loading">
                    ...
                    <div class="shoplist el-col el-col-24 goods-cate">
                            <div  class="classified">选品分类展示：</div>
                            <div>
                                <el-radio v-model="radio" label="1" @change="shopcateone">选品分类1</el-radio>
                            ...
                            <div>
                                <el-radio v-model="radio" label="2" @change="shopcatetwo">选品分类2</el-radio>
                    ...
                    <div class="goods_table-all">
                        <el-table
                            ...
                            <el-table-column prop="spuNum" label="商品数量" >  </el-table-column>
                            <el-table-column  prop="serial" label="排序" show-overflow-tooltip > </el-table-column>
                            <el-table-column prop="createTime" label="创建时间" :formatter="dateFormat" show-overflow-tooltip> </el-table-column>
                            <el-table-column prop="handle" label="操作" min-width="120">
...
export default {
    ...
    methods: {  
        ...
        intoDetail(id){
              this.$router.push({ //src/components/goods/select_goodscategoryDetail.vue
                path: `/goodslist/goodscaselect_goodscategoryDetailtegoryDetail/${id}`
            })
        },
        //旧版删除
...
            },
        ...
        getdata(){
            ...
            let urlStr = baseapi.shopcatexiang;
