                    ...
                    <div class="goods-card_body" v-loading="loading">
                        ...
                        <div class="shuaixuan vip-alllist mh-order-hight">
                            ...
                            <div class="m-search-box el-row el-row-my-div">
                                ...
                                <div>
                                    <label class="el-form-item__label" style="min-width: 95px;">收货人姓名：</label>
                                    <el-input v-model="inordernumber" placeholder="">{{inordernumber}}</el-input>
                                </div>
                                <div>
                                    <label class="el-form-item__label" style="width: 130px;">手机号：</label>
                                    <el-input v-model="inordernumber" placeholder="">{{inordernumber}}</el-input>
                                </div>

                                <div>
                                    <label class="el-form-item__label" style="width: 130px;">下单状态：</label>
                                    <el-select v-model="value8" placeholder="请选择订单状态">
                            ...
                            <div class="m-search-box el-row el-row-my-div">
                                <div class="sx-input mh-order">
                                    <label class="el-form-item__label" style="width: 130px;">店铺ID：</label>
                                    <el-input v-model="inordernumber" placeholder="">{{inordernumber}}</el-input>
                                </div>
                                <div>
                                    <label class="el-form-item__label" style="width: 130px;">店铺名称：</label>
                                    <el-input v-model="inordernumber" placeholder="">{{inordernumber}}</el-input>
                                </div>
                                ...
                                <div>
                                    <label class="el-form-item__label" style="width: 130px;">物流单号：</label>
                                    <el-input v-model="value7" placeholder="请输入物流单号"></el-input>
                                </div>
                            ...
                            <div class=""  style="display: flex;" >
                                <div style="display: flex;">
                                    <label class="el-form-item__label" style="min-width: 80px; margin-left: 8px;">商品ID：</label>
                                    <el-input v-model="value7" placeholder="请输入商品ID" style="min-width: 130px;"></el-input>
                                </div>
                                <div style="display: flex;">
                                    <label class="el-form-item__label" style="width: 130px;">商品名称：</label>
                                    <el-input v-model="value7" placeholder="请输入商品名称" style="min-width: 130px;"></el-input>
                                </div>    

                                <div style="display: flex;">
                                    <label class="el-form-item__label" style=""></label>

                                     <el-select v-model="value10" placeholder="下单时间" style="width: 110px; margin: 0 10px 0 20px;">
...
import { zm_getOrderTypeList } from '../../filters/zm_data';
...
export default {
    data() {
        return {
            ...
            //订单状态
            orderTypeList: zm_getOrderTypeList(),
            //物流公司
            wuliugs: [{
                value: '1',
                label: '申通'
